...
namespace QuanLyQuanBilliards.Helpers
{
    ...
    {
        // Thông tin kết nối - CẬP NHẬT THEO MÁY CHỦ CỦA BẠN
        // Có thể lấy từ App.config hoặc cấu hình tùy chỉnh
        ...
        // CHÚ Ý: Mật khẩu chỉ là ví dụ demo, khi triển khai thực tế cần bảo mật hơn
        ...
        public static string GetConnectionString(string vaiTro)
        {
            ...
            var sqlBuilder = new SqlConnectionStringBuilder
            {
                ...
                UserID = login,
                Password = password,
                IntegratedSecurity = false, // Sử dụng SQL Authentication thay vì Windows
                Encrypt = false,
