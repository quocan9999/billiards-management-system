...
BEGIN
    ...
    -- TRANSACTION 2: Đảm bảo tính nguyên tử của giao dịch thanh toán
    BEGIN TRANSACTION;
...
-- Tắt trigger tạm thời để insert dữ liệu lịch sử
...
-- 2. Map LOGIN vào CSDL QuanLyQuanBilliards thành USER
USE QuanLyQuanBilliards;
GO
...
/* =============================================================
   FILE 2 - PHÂN QUYỀN TRUY CẬP (GRANT / DENY / REVOKE)
   CHO HỆ THỐNG CSDL QuanLyQuanBilliards
   ============================================================= */
...
/* -------------------------------------------------------------
   ...
   - Có thể cho vào nhóm db_owner để toàn quyền trong database.
   ------------------------------------------------------------- */

-- Cách nhanh nhất: cho role dbrole_QuanTri thuộc nhóm db_owner
